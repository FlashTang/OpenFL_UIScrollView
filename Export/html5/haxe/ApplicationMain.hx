...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("OpenFlScrollView", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("OpenFlScrollView", null, 0, 0);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "OpenFlScrollView";
		app.meta["name"] = "OpenFlScrollView";
		app.meta["packageName"] = "com.sample.openflscrollview";
		...
		#elseif air
		app.window.title = "OpenFlScrollView";
		#else
